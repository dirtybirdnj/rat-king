...
// Import CLI commands
use cli::{cmd_fill, cmd_benchmark, generate_pattern};
...
// cmd_fill and cmd_benchmark are now in cli/ module
...
struct HarnessResult {
    ...
    solid_screenshot: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pattern_screenshot: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
